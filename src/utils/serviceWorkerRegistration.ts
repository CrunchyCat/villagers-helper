        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              console.log(
                'New content is available. Close all tabs of this page to update. See https://cra.link/PWA.'
              )
              ...
              // At this point, everything has been precached. It's the perfect time
