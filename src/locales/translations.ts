...
/*
 * Converts the static JSON file into an object where keys are identical but values are strings concatenated according
 * to syntax. It's helpful when using the JSON file keys and having the intellisense support along with type-safety
 */
