...
export const cards = {
  /* Grains Villagers */
  '0_0': { name: 'Founders', img_front: founders, img_back: back_founders },
  '0_1': { name: 'Brewer', img_front: brewer, img_back: back_grains },
  '0_2': { name: 'Poulterer', img_front: poulterer, img_back: back_grains },
  '0_3': { name: 'Swineherd', img_front: swineherd, img_back: back_grains },
  '0_4': { name: 'Truffler', img_front: truffler, img_back: back_grains },
  /* Wood Villagers */
  '1_0': { name: 'Lumberjack', img_front: lumberjack, img_back: back_lumberjack },
  '1_1': { name: 'Carpenter', img_front: carpenter, img_back: back_wood },
  '1_2': { name: 'Cartwright', img_front: cartwright, img_back: back_wood },
  '1_3': { name: 'Cooper', img_front: cooper, img_back: back_wood },
  '1_4': { name: 'Log Rafter', img_front: log_rafter, img_back: back_wood },
  '1_5': { name: 'Shipwright', img_front: shipwright, img_back: back_wood },
  '1_6': { name: 'Wheeler', img_front: wheeler, img_back: back_wood },
  '1_7': { name: 'Wood Carver', img_front: wood_carver, img_back: back_wood },
  '1_8': { name: 'Arkwright', img_front: arkwright, img_back: back_wood },
  '1_9': { name: 'Healey', img_front: healey, img_back: back_wood },
  /* Hay Villagers */
  '2_0': { name: 'Hayer', img_front: hayer, img_back: back_hayer },
  '2_1': { name: 'Bed Builder', img_front: bed_builder, img_back: back_hay },
  '2_2': { name: 'Fromager', img_front: fromager, img_back: back_hay },
  '2_3': { name: 'Grazier', img_front: grazier, img_back: back_hay },
  '2_4': { name: 'Horse Trader', img_front: horse_trader, img_back: back_hay },
  '2_5': { name: 'Milk Maid', img_front: milk_maid, img_back: back_hay },
  '2_6': { name: 'Ore Muler', img_front: ore_muler, img_back: back_hay },
  '2_7': { name: 'Peddler', img_front: peddler, img_back: back_hay },
  '2_8': { name: 'Thatcher', img_front: thatcher, img_back: back_hay },
  '2_9': { name: 'Carter', img_front: carter, img_back: back_hay },
  '2_10': { name: 'Vasel', img_front: vasel, img_back: back_hay },
  /* Ore Villagers */
  '3_0': { name: 'Miner', img_front: miner, img_back: back_miner },
  '3_1': { name: 'Blacksmith', img_front: blacksmith, img_back: back_ore },
  '3_2': { name: 'Glass Blower', img_front: glass_blower, img_back: back_ore },
  '3_3': { name: 'Jeweler', img_front: jeweler, img_back: back_ore },
  '3_4': { name: 'Locksmith', img_front: locksmith, img_back: back_ore },
  '3_5': { name: 'Mason', img_front: mason, img_back: back_ore },
  '3_6': { name: 'Seeker', img_front: seeker, img_back: back_ore },
  '3_7': { name: 'Spelunker', img_front: spelunker, img_back: back_ore },
  '3_8': { name: 'Alchemist', img_front: alchemist, img_back: back_ore },
  '3_9': { name: 'Garcia', img_front: garcia, img_back: back_ore },
  /* Grapes Villagers */
  '5_0': { name: 'Graper', img_front: graper, img_back: back_grapes },
  '5_1': { name: 'Vintner', img_front: vintner, img_back: back_grapes },
  '5_2': { name: 'Wine Trader', img_front: wine_trader, img_back: back_grapes },
  /* Wool Villagers */
  '6_0': { name: 'Shepherd', img_front: shepherd, img_back: back_wool },
  '6_1': { name: 'Spinner', img_front: spinner, img_back: back_wool },
  '6_2': { name: 'Tailor', img_front: tailor, img_back: back_wool },
  '6_3': { name: 'Weaver', img_front: weaver, img_back: back_wool },
  /* Leather Villagers */
  '7_0': { name: 'Cobbler', img_front: cobbler, img_back: back_leather },
  '7_1': { name: 'Saddler', img_front: saddler, img_back: back_leather },
  '7_2': { name: 'Tanner', img_front: tanner, img_back: back_leather },
  /* Solitary Villagers */
  '8_0': { name: 'Agent', img_front: agent, img_back: back_solitary },
  '8_1': { name: 'Beekeeper', img_front: beekeeper, img_back: back_solitary },
  '8_2': { name: 'Chandler', img_front: chandler, img_back: back_solitary },
  '8_3': { name: 'Fisher', img_front: fisher, img_back: back_solitary },
  '8_4': { name: 'Freemason', img_front: freemason, img_back: back_solitary },
  '8_5': { name: 'Grocer', img_front: grocer, img_back: back_solitary },
  '8_6': { name: 'Harvester', img_front: harvester, img_back: back_solitary },
  '8_7': { name: 'Hunter', img_front: hunter, img_back: back_solitary },
  '8_8': { name: 'Priest', img_front: priest, img_back: back_solitary },
  '8_9': { name: 'Wattler', img_front: wattler, img_back: back_solitary },
  '8_10': { name: 'Captain', img_front: captain, img_back: back_solitary },
  '8_11': { name: 'Wholesaler', img_front: wholesaler, img_back: back_solitary },
  '8_12': { name: 'Plower', img_front: plower, img_back: back_solitary },
  '8_13': { name: 'Scribe', img_front: scribe, img_back: back_solitary },
  /* Special Villagers */
  '9_0': { name: 'Apprentice', img_front: apprentice, img_back: back_special },
  '9_1': { name: 'Monk', img_front: monk, img_back: back_special },
  '9_2': { name: 'Smuggler', img_front: smuggler, img_back: back_special },
  '9_3': { name: 'Tinner', img_front: tinner, img_back: back_special },
  '9_4': { name: 'Benefactor', img_front: benefactor, img_back: back_special },
  '9_5': { name: 'Nun', img_front: nun, img_back: back_special },
  '9_6': { name: 'Pigeoneer', img_front: pigeoneer, img_back: back_special },
  '9_7': { name: 'Prophet', img_front: prophet, img_back: back_special },
  '9_8': { name: 'Recruiter', img_front: recruiter, img_back: back_special },
  '9_9': { name: 'Barbarian', img_front: barbarian, img_back: back_special },
  '9_10': { name: 'Courier', img_front: courier, img_back: back_special },
  '9_11': { name: 'Flaker', img_front: flaker, img_back: back_special },
  '9_12': { name: 'Noble', img_front: noble, img_back: back_special },
  '9_13': { name: 'Schemer', img_front: schemer, img_back: back_special },
  '9_14': { name: 'Sheriff', img_front: sheriff, img_back: back_special },
  '9_15': { name: 'Thief', img_front: thief, img_back: back_special },
  '9_16': { name: 'Freelancer', img_front: freelancer, img_back: back_special }
}
...
export const suits = [
  { /* Grains Villagers */
    ...
    cards: ['0_0', '0_1', '0_2', '0_3', '0_4']
  },
  { /* Wood Villagers */
    id: 1, name: 'Wood', img: suit_wood, color: '#9DC274',
    cards: ['1_0', '1_1', '1_2', '1_3', '1_4', '1_5', '1_6', '1_7', '1_8', '1_9']
  },
  { /* Hay Villagers */
    id: 2, name: 'Hay', img: suit_hay, color: '#7F499F',
    cards: ['2_0', '2_1', '2_2', '2_3', '2_4', '2_5', '2_6', '2_7', '2_8', '2_9', '2_10']
  },
  { /* Ore Villagers */
    id: 3, name: 'Ore', img: suit_ore, color: '#0D0709',
    cards: ['3_0', '3_1', '3_2', '3_3', '3_4', '3_5', '3_6', '3_7', '3_8', '3_9']
  },
  { /* Grapes Villagers */
  ...
  { /* Solitary Villagers */
    ...
    cards: ['8_0', '8_1', '8_2', '8_3', '8_4', '8_5', '8_6', '8_7', '8_8', '8_9', '8_10', '8_11', '8_12', '8_13']
  },
  { /* Special Villagers */
    id: 9, name: 'Special', img: suit_special, color: '#FE5240',
    cards: ['9_0', '9_1', '9_2', '9_3', '9_4', '9_5', '9_6', '9_7', '9_8', '9_9', '9_10', '9_11', '9_12', '9_13', '9_14', '9_15', '9_16']
  }
]
